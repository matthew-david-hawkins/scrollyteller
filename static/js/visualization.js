...
//--------------------------------------------------
function tweetReachVsTime(tweets){
// args - tweets: json
// Given a set a tweets, group them by day and retweets + favorites, add trace to lineplot with the data
  ...
  Plotly.addTraces("lineplot", {x: groupedDates.slice(1,-1), y: groupedPopularity.slice(1,-1), name: screen_name}); // Don't plot the first or last pair because of incomplete data
